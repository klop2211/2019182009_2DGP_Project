...
def enter():
    ...
    biggrayskels.append(Biggrayskel_object.Biggrayskel(16 * 40, 2 * 40, 7, 100, 0))
    biggrayskels.append(Biggrayskel_object.Biggrayskel(7 * 40, 5 * 40, 7, 100, 0))
    biggrayskels.append(Biggrayskel_object.Biggrayskel(24 * 40, 8 * 40, 7, 100, 0))
    biggrayskels.append(Biggrayskel_object.Biggrayskel(17 * 40, 13 * 40, 7, 100, 0))
    biggrayskels.append(Biggrayskel_object.Biggrayskel(10 * 40, 12 * 40, 7, 100, 0))
